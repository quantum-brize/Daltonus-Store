                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mt-2 text-center">
                            <lord-icon src="<?= base_url()?>../../../gsqxdxog-1.json" trigger="loop" colors="primary:#f7b84b,secondary:#f06548" style="width:100px;height:100px"></lord-icon>
                ...
                <div class="row g-2">
                    <div class="col-lg-7">
                        <a href="#!" class="product-banner-1 mt-4 mt-lg-0 rounded overflow-hidden d-block">
                            <img src="<?= base_url()?>public/assets/images/ecommerce/features/img-5.jpg" class="w-100 rounded object-fit-cover" alt="" style="max-height: 480px;">
                    ...
                    <div class="col-lg-5">
                        <div class="row g-2">
                            <div class="col-lg-12">
                                <a href="#!" class="product-banner-1 mt-4 mt-lg-0 rounded overflow-hidden d-block">
                                    <img src="<?= base_url()?>public/assets/images/ecommerce/features/img-4.jpg" class="w-100 rounded object-fit-cover" alt="" style="max-height: 236px;">
                            ...
                            <div class="col-lg-12">
                                <a href="#!" class="product-banner-1 mt-4 mt-lg-0 rounded overflow-hidden d-block">
                                    <img src="<?= base_url()?>public/assets/images/ecommerce/features/img-1.jpg" class="w-100 rounded object-fit-cover" alt="" style="max-height: 236px;">
                                    <div class="product-content p-3 ps-5">
