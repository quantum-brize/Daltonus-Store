                    ...
                    <div class="product-banner-1 mt-3 mt-lg-0 rounded overflow-hidden">
                        ...
                        <div class="product-content p-4">
                            ...
                            <div class="product-btn mt-3 mt-xl-4">
                                <a href="product-list-defualt.html" class="link-effect link-light text-white fs-14">Shop Now <i class="bi bi-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product-banner-1 mt-4 mt-lg-0 rounded overflow-hidden right">
                        ...
                        <div class="product-content p-4 text-end">
                            ...
                            <h1 class="text-white lh-base ff-secondary display-6 display-xl-5">Running Shoes Sales Up to 50%</h1>
                            <div class="product-btn mt-3 mt-xl-4">
                                <a href="product-list-sidebar-banner.html" class="link-effect link-light text-white fs-14">Shop Now <i class="bi bi-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product-banner-1 mt-4 mt-lg-0 rounded overflow-hidden">
                        ...
                        <div class="product-content p-4">
                            ...
                            <div class="product-btn mt-3 mt-xl-4">
                                <a href="product-list-right.html" class="link-effect link-primary fs-14">Shop Now <i class="bi bi-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row gy-4 gy-lg-0">
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="ecommerce-deals-widgets">
                        <div class="card overflow-hidden mb-0">
                            <div class="gallery-product">
                                <img src="<?= base_url()?>/public/assets/images/ecommerce/img-1.jpg" alt="" class="mx-auto d-block object-fit-cover">
                            </div>
                        </div>
                        <div class="content mx-4">
                            <div class="countdown-deals mb-3">
