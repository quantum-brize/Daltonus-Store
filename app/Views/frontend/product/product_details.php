                            ...
                            <div class="col-md-2">
                                <div thumbsslider="" class="swiper productSwiper mb-3 mb-lg-0">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="product-thumb rounded cursor-pointer">
                                                <img src="<?= base_url()?>/public/assets/images/products/img-32-1.png" alt="" class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="product-thumb rounded cursor-pointer">
                                    ...
                                    <div class="mt-4" data-simplebar="" style="max-height: 350px">
                                        <div class="d-flex p-3 border-bottom border-bottom-dashed">
                                            <div class="flex-shrink-0 me-3">
                                                <img class="avatar-xs rounded-circle" src="<?= base_url()?>/public/assets/images/users/avatar-5-1.jpg" alt="">
                                            </div>
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex mt-4">
                                                    <div class="flex-shrink-0 me-3">
                                                        <img class="avatar-xs rounded-circle" src="<?= base_url()?>/public/assets/images/users/avatar-1-1.jpg" alt="">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <div class="d-flex mb-3">
                                                            <div class="flex-grow-1">
                                        ...
                                        <div class="d-flex p-3 border-bottom border-bottom-dashed">
                                            <div class="flex-shrink-0 me-3">
                                                <img class="avatar-xs rounded-circle" src="<?= base_url()?>/public/assets/images/users/avatar-3-1.jpg" alt="">
                                            </div>
                                            <div class="flex-grow-1">
                                                <div class="d-flex mb-3">
                                                    <div class="flex-grow-1">
                                        ...
                                        <div class="d-flex p-3 border-bottom border-bottom-dashed mb-3">
                                            <div class="flex-shrink-0 me-3">
                                                <img class="avatar-xs rounded-circle" src="<?= base_url()?>/public/assets/images/users/avatar-8-1.jpg" alt="">
                                            </div>
                                            <div class="flex-grow-1">
                                                <div class="d-flex mb-3">
                                                    <div class="flex-grow-1">
                ...
                <div class="row gy-3">
                    <div class="col-lg-4">
                        <a href="product-grid-right.html" class="card mb-3 card-animate stretched-link">
                            <div class="row g-0">
                                <div class="col-sm-4">
                                    <img src="<?= base_url()?>/public/assets/images/ecommerce/img-5.jpg" class="img-fluid rounded-start h-100 object-fit-cover" alt="...">
                                </div>
                                <div class="col-sm-8">
                    ...
                    <div class="col-lg-4">
                        <a href="product-grid-right.html" class="card mb-3 card-animate stretched-link">
                            <div class="row g-0">
                                <div class="col-sm-4">
                                    <img src="<?= base_url()?>/public/assets/images/ecommerce/img-2.jpg" class="img-fluid rounded-start h-100 object-fit-cover" alt="...">
                                </div>
                                <div class="col-sm-8">
                                    <div class="card-body h-100 d-flex flex-column">
                    ...
                    <div class="col-lg-4">
                        <a href="product-grid-right.html" class="card mb-3 card-animate stretched-link">
                            <div class="row g-0">
                                <div class="col-sm-4">
                                    <img src="<?= base_url()?>/public/assets/images/ecommerce/img-3.jpg" class="img-fluid rounded-start h-100 object-fit-cover" alt="...">
                                </div>
                                <div class="col-sm-8">
                                    <div class="card-body h-100 d-flex flex-column">
                    ...
                    <div class="col-xxl-3 col-lg-4 col-sm-6">
                        <div class="card ecommerce-product-widgets border-0 rounded-0 shadow-none overflow-hidden card-animate">
                            <div class="bg-light bg-opacity-50 rounded py-4 position-relative">
                                <img src="<?= base_url()?>/public/assets/images/products/img-12.png" alt="" style="max-height: 200px;max-width: 100%;" class="mx-auto d-block rounded-2">
