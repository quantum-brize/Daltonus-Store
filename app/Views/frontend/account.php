...
<div class="offcanvas offcanvas-end product-list" tabindex="-1" id="ecommerceCart" aria-labelledby="ecommerceCartLabel">
        ...
        <section class="position-relative">
            <div class="profile-basic position-relative" style="background-image: url('<?= base_url()?>/public/assets/images/profile-bg-1.jpg');background-size: cover;background-position: center; height: 300px;">
