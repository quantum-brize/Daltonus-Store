                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6">
                                <div>
                                    <p class="fs-15 fw-semibold text-uppercase">
                                        <i class="ri-flashlight-fill text-info align-bottom me-1"></i>
                        ...
                        <div class="row justify-content-end">
                            <div class="col-lg-6">
                                <div class="text-end">
                                    ...
                                    <h1 class="display-4 fw-semibold text-capitalize lh-base text-dark">
                        ...
                        <div class="card overflow-hidden">
                            <div class="bg-warning-subtle rounded-top py-4">
                                ...
                                <div class="product-btn px-3">
                                    <a href="shop-cart.html" class="btn btn-primary btn-sm w-75 add-btn"><i
                            ...
                            <div class="card-body">
                                <div>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h5 class="mb-0">
                                            $199.00
                                            <span class="text-muted fs-12"><del>$425.00</del></span>
                                        </h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card overflow-hidden">
                            ...
                            <div class="card-body">
                                <div>
                                    ...
                                    <div class="mt-3">
                                        <span class="float-end">4.3
                                            <i class="ri-star-half-fill text-warning align-bottom"></i></span>
                                        <h5 class="mb-0">
                                            $299.00
                                            <span class="text-muted fs-12"><del>$399.00</del></span>
                                        </h5>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card overflow-hidden">
                            ...
                            <div class="card-body">
                                <div>
                                    ...
                                    <div class="mt-3">
                                        <span class="float-end">2.6
                                            <i class="ri-star-half-fill text-warning align-bottom"></i></span>
                                        <h5 class="mb-0">
                                            $169.00
                                            <span class="text-muted fs-12"><del>$225.00</del></span>
                                        </h5>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h5 class="mb-0">
                                            $435.00
                                            <span class="text-muted fs-12"><del>$636.00</del></span>
                                        </h5>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div>
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <h5 class="mb-0">
                                                $125.00
                                                <span class="text-muted fs-12"><del>$200.00</del></span>
                                            </h5>
                                        </div>
                                        <div class="mt-3">
                                            <a href="shop-cart.html" class="btn btn-primary btn-sm"><i
                                                    class="mdi mdi-cart me-1"></i> Add to cart</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div>
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <h5 class="mb-0">
                                                $150.00
                                                <span class="text-muted fs-12"><del>$300.00</del></span>
                                            </h5>
                                        </div>
                                        <div class="mt-3">
                                            <a href="shop-cart.html" class="btn btn-primary btn-sm"><i
                            ...
                            <div class="card overflow-hidden">
                                ...
                                <div class="card-body">
                                    <div>
                                        ...
                                        <div class="mt-3">
                                            <span class="float-end">2.3
                                                <i class="ri-star-half-fill text-warning align-bottom"></i></span>
                                            <h5 class="mb-0">
                                                $135.00
                                                <span class="text-muted fs-12"><del>$523.00</del></span>
                                            </h5>
                                        </div>
                                        <div class="mt-3">
                                            <a href="shop-cart.html" class="btn btn-primary btn-sm"><i
                            ...
                            <div class="card overflow-hidden">
                                ...
                                <div class="card-body">
                                    <div>
                                        ...
                                        <div class="mt-3">
                                            <span class="float-end">3.5
                                                <i class="ri-star-half-fill text-warning align-bottom"></i></span>
                                            <h5 class="mb-0">
                                                $99.00
                                                <span class="text-muted fs-12"><del>$129.00</del></span>
                                            </h5>
                                        </div>
                                        <div class="mt-3">
                                            <a href="shop-cart.html" class="btn btn-primary btn-sm"><i
                                ...
                                <div class="card-body">
                                    <div>
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <h5 class="mb-0">
                                                $632.00
                                                <span class="text-muted fs-12"><del>$721.00</del></span>
                                            </h5>
                                        </div>
                                        <div class="mt-3">
                                            <a href="shop-cart.html" class="btn btn-primary btn-sm"><i
