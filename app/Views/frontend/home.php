    ...
    <div class="container">
        ...
        <div class="row mt-5">
            <div class="col-lg-12">
                ...
                <div class="row gallery-wrapper mt-4 pt-2" id="all_products">
                    
                </div>

                <div class="text-center view-all-products">
                    <a href="<?= base_url('product/list')?>" class="btn btn-soft-primary btn-hover">View All Products
