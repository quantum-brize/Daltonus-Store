...
<body>
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg bg-light border-primary text-center" onkeyup="moveToNext(1, event)" maxLength="1" id="digit1-input">
                                                </div>
                                            </div><!-- end col -->
                                            ...
                                            <div class="col-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg bg-light border-primary text-center" onkeyup="moveToNext(2, event)" maxLength="1" id="digit2-input">
                                                </div>
                                            </div><!-- end col -->
                                            ...
                                            <div class="col-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg bg-light border-primary text-center" onkeyup="moveToNext(3, event)" maxLength="1" id="digit3-input">
                                                </div>
                                            </div><!-- end col -->
                                            ...
                                            <div class="col-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg bg-light border-primary text-center" onkeyup="moveToNext(4, event)" maxLength="1" id="digit4-input">
                                                </div>
                                            </div><!-- end col -->
                                        </div>
                                    </form><!-- end form -->
    ...
    <script src="<?= base_url()?>assets_admin/js/pages/two-step-verification.init.js"></script>
</body>
