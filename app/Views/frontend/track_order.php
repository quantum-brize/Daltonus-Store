                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar-sm flex-shrink-0">
                                                <div class="avatar-title bg-dark-subtle rounded-3">
                                                    <img src="<?= base_url()?>/public/assets/images/products/img-16.png" alt="" class="avatar-xs">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
                                ...
                                <tr>
                                    ...
                                    <td class="text-start">
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar-sm flex-shrink-0">
                                                <div class="avatar-title bg-warning-subtle rounded-3">
                                                    <img src="<?= base_url()?>/public/assets/images/products/img-6-1.png" alt="" class="avatar-xs">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar-sm flex-shrink-0">
                                                <div class="avatar-title bg-secondary-subtle rounded-3">
                                                    <img src="<?= base_url()?>/public/assets/images/products/img-8-1.png" alt="" class="avatar-xs">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1">
                        ...
                        <div class="row align-items-center gy-3 gy-md-0">
                            <div class="col-md-4">
                                <div class="d-flex align-items-center justify-content-between justify-content-md-start text-end text-md-start">
                                    <div class="">
                                        <lord-icon src="../../../uetqnvvg.json" trigger="loop" colors="primary:#438eff,secondary:#0ab39c" style="width:70px;height:70px"></lord-icon>
                                    </div>
                                    <div class="ms-2">
                                        <h6>RQK Logistics</h6>
