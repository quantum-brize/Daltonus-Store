...
<div class="offcanvas offcanvas-end product-list" tabindex="-1" id="ecommerceCart" aria-labelledby="ecommerceCartLabel">
        ...
        <section class="section pb-0 mt-4">
            <div class="container-fluid">
                <div class="position-relative rounded-3" style="background-image: url('<?= base_url()?>/public/assets/images/ecommerce/banner.jpg');background-size: cover;background-position: center;">
                    ...
                    <div class="offer-bar flex-shrink-0">
                        <div class="d-flex gap-3 flex-column">
                            <div class="card fs-13 border border-primary border-opacity-25">
                                ...
                                <div class="card-body">
                                    <div class="px-5">
                                        <img src="<?= base_url()?>/public/assets/images/products/img-16.png" alt="" class="img-fluid d-block mx-auto">
                                    </div>
                            ...
                            <div class="offer-banner rounded-3" style="background-image: url('<?= base_url()?>/public/assets/images/ecommerce/offer-banner-1.jpg');background-size: cover;background-position: center;"></div>
                        </div>
                    </div>
                </div>
